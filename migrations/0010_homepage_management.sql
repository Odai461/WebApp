...
-- Homepage Sections (Reorderable, Enable/Disable)
CREATE TABLE IF NOT EXISTS homepage_sections (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    section_type TEXT NOT NULL, -- 'product_slider', 'faq', 'b2b', 'partners', etc.
    title TEXT,
    subtitle TEXT,
    category TEXT, -- For product sliders: 'Windows', 'Office', etc.
    settings TEXT, -- JSON settings for each section
    order_position INTEGER DEFAULT 0,
    is_active BOOLEAN DEFAULT 1,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
...
INSERT OR IGNORE INTO homepage_sections (id, section_type, title, subtitle, category, order_position, is_active) VALUES
(1, 'product_slider', '🔥 Top-Angebote des Tages', NULL, 'deals', 1, 1),
(2, 'faq', 'Häufig gestellte Fragen', 'Alles, was Sie über den Kauf von Software-Lizenzen wissen müssen', NULL, 2, 1),
(3, 'bekannt_aus', 'Softwareking24.de bekannt aus', 'Vertrauen Sie auf unsere langjährige Erfahrung', NULL, 3, 1),
(4, 'b2b', 'Attraktive Angebote für Firmen & Gewerbetreibende', 'Profitieren Sie von unseren exklusiven Geschäftskundenkonditionen', NULL, 4, 1),
(5, 'product_slider', 'Windows Betriebssysteme', NULL, 'Windows', 5, 1),
(6, 'partners', 'Unsere Partner', 'Autorisierter Partner der führenden Software-Hersteller weltweit', NULL, 6, 1),
(7, 'process_steps', 'So einfach geht''s', 'In 4 einfachen Schritten zu Ihrer Software', NULL, 7, 1),
(8, 'product_slider', 'Microsoft Office Pakete', NULL, 'Office', 8, 1),
(9, 'category_grid', 'Beliebte Software-Kategorien', 'Entdecken Sie unser umfangreiches Sortiment', NULL, 9, 1),
(10, 'product_slider', 'Server & CAL Lizenzen', NULL, 'Server', 10, 1),
(11, 'product_slider', 'Antivirus & Sicherheit', NULL, 'Antivirus', 11, 1),
(12, 'newsletter', 'Newsletter abonnieren', 'Erhalten Sie exklusive Angebote und Neuigkeiten direkt in Ihr Postfach', NULL, 12, 1);
...
CREATE INDEX IF NOT EXISTS idx_homepage_sections_active ON homepage_sections(is_active, order_position);
